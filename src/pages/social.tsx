      ...
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            margin: 0,
            lineHeight: 1.2
          }}>Ads that <span style={{ color: '#ff6a00' }}>perform</span></h1>
          ...
          <p style={{
            ...
            lineHeight: 1.6,
            margin: 0
          }}>From content to conversion — we craft, target, and scale what works.</p>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <h3 style={{ color: 'white', margin: 0 }}>Ad creative design</h3>
                <p style={{ color: '#999', margin: '0.5rem 0 0 0' }}>Video, carousel, and static ads that convert</p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div>
                <h3 style={{ color: 'white', margin: 0 }}>Targeted setup</h3>
                <p style={{ color: '#999', margin: '0.5rem 0 0 0' }}>Precise audience targeting & lookalike modeling</p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div>
                <h3 style={{ color: 'white', margin: 0 }}>Campaign optimization</h3>
                <p style={{ color: '#999', margin: '0.5rem 0 0 0' }}>Daily monitoring & performance scaling</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <h3 style={{ color: 'white', margin: 0, fontSize: '1.5rem' }}>Performance Overview</h3>
                <p style={{ color: '#999', margin: '0.5rem 0 0 0' }}>ROAS and Conversions Growth</p>
              </div>
              <div style={{
                display: 'flex',
                gap: '1rem',
